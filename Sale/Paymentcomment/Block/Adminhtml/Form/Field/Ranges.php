<?php
namespace Sale\Paymentcomment\Block\Adminhtml\Form\Field;
...
use Sale\Paymentcomment\Block\Adminhtml\Form\Field\TaxColumn;
...

{
...

    {
        ...
        $this->addColumn('from_qty', ['label' => __('Custom field'), 'class' => 'required-entry']);
